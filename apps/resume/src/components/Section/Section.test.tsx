...
describe('resume - components - Section', () => {
    it('should has margin top', () => {
        ...
        expect(screen.getByTestId(SECTION_TEST_ID)).toHaveStyle({
            marginTop: '3rem',
        });
    });
    ...
    it('should has margin top at only first child', () => {
        ...
        expect(screen.getByTestId(FIRST_DIV_TEST_ID)).toHaveStyle({
            marginTop: '2rem',
        });
        expect(screen.getByTestId(SECOND_DIV_TEST_ID)).not.toHaveStyle({
            marginTop: '2rem',
        });
    });
});
